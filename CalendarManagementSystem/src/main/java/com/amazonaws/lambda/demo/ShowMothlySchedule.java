...
public class ShowMothlySchedule implements RequestStreamHandler {
        ...
        try {
            if (request.getPathParameters() != null) {
                ...
                if (request.getQueryStringParameters() != null) {
                    String month = request.getQueryStringParameters().month;

                    c1 = mDao.showMonthlySchedule(calendarName, month);
